...
//			accountlist.get(accountid); Problem was solved after changing get() to put()
	...
	public void deposit(String accountid, Money money) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(accountid)) {
//		if (accountlist.containsKey(accountid)) {     condition was incorrect
	...
	public void withdraw(String accountid, Money money) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(accountid)) {
			...
			Account account = accountlist.get(accountid);
//			account.deposit(money);
//			method withdraw should be called instead of deposit
...
//		transfer(fromaccount, this, fromaccount, amount);  toaccount should be passed instead of fromaccount second time
